...
<img src="https://github.com/ZiayzuLauncher/ZiayzuLauncher/blob/v3_openjdk/app_pojavlauncher/src/main/assets/pojavlauncher.png" align="left" width="150" height="150" alt="Ziayzu Launcher logo">
...
1. You can get the prebuilt app from [automatic builds](https://github.com/ZiayzuLauncher/ZiayzuLauncher/actions).
...
## License
- Ziayzu Launcher is licensed under [GNU LGPLv3](https://github.com/ZiayzuLauncher/ZiayzuLauncher/blob/v3_openjdk/LICENSE).
...
- [LWJGL3](https://github.com/ZiayzuLauncher/lwjgl3): [BSD-3 License](https://github.com/LWJGL/lwjgl3/blob/master/LICENSE.md).
